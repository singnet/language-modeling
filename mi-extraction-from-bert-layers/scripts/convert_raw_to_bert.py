...
argp = ArgumentParser()
argp.add_argument('--input_path', default="example/bert-base-suarez/ptb-data/ptb3-wsj-test.txt")
argp.add_argument('--output_path', default="example/bert-base-suarez/ptb-data/ptb3-wsj-test.hdf5")
argp.add_argument('--bert_model', default="base", help='base or large')
args = argp.parse_args()

# Load pre-trained model tokenizer (vocabulary)
# Crucially, do not do basic tokenization; PTB is tokenized. Just do wordpiece tokenization.
if args.bert_model == 'base':
  tokenizer = BertTokenizer.from_pretrained('example/bert-base-suarez/suarez_checkpoint/')
  model = BertModel.from_pretrained('example/bert-base-suarez/suarez_checkpoint/')
  LAYER_COUNT = 12
  FEATURE_COUNT = 768
