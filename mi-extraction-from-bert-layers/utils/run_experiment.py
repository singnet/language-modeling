...
def run_train_probe(args, probe, dataset, model, loss, reporter, regimen):
  """Trains a utils according to args.
...
def run_report_results(args, probe, dataset, model, loss, reporter, regimen):
  """
  Reports results from a utils according to args.
...
if __name__ == '__main__':
  argp = ArgumentParser()
  argp.add_argument('--experiment_config', default='examplebert-base-suarez/config/ptb-prd-BERTbase7.yaml')
